...
import { enderecoServidor, nomesTipoConta, iconesTipoConta, iconesCategoria, calcularDatasPeriodo, listaCores, CORES_GRAFICO, formatarDinheiro } from '../utils'
...
export default function Dashboard() {
    ...
    // Variaveis de estado para a analise com IA
    ...
    // Função para chamar a api da openAI para analise
    // Ultima função em react do curso
    const analiseComIA = async () => {
        ...
        try {
            ...
            const prompt = `
            Voê é um consultor financeiro inteligente. Analise os dados que estou enviando 
            -Receitas: ${dadosDashboard.kpis.receitas}
            -Despesas: ${dadosDashboard.kpis.despesas}
            -Detalhamento de despesas por categoria: ${dadosDashboard.categorias}
            -Detalhamento de despesas por subcategoria: ${dadosDashboard.subcategorias}
            -Ultimos 6 meses: ${dadosDashboard.evolucao6meses}
            Com base nisso, forneça uma analise objetiva e curta (máx 150 palavras):
            1. Uma avaliação geral da saude financeira desse periodo.
            2. Aponte a categoria e subcategoria que mais impactou as despesas (se necessario).
            3. De uma dica pratica e acionavel para melhorar no proximo mes.
            4. 
            `;
    ...
    return (
        <div>
            ...
            {/* Seção 3 : Grafico dos ultimos 6 meses */}
            <section className='grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6'>
                <div className='bg-white p-6 rounded-lg shadow-md'>
                    <h3 className='text-xl font-bold mb-4 text-gray-800'>Ultimos 6 meses</h3>
                        ...
                        {dadosDashboard.evolucao6meses.length == 0 ?
                            ...
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart data={dadosDashboard.evolucao6meses} >
                                    ...
                                    <Bar dataKey='total_despesas' fill='#ff4444' name='Despesas' radius={[8, 8, 0, 0]} />
                                </BarChart>
                            </ResponsiveContainer>
                        }
                    </div>
            ...
            {/* Incluindo na tela o Modal se a variavel estiver true */}
