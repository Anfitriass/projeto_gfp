...
export default function SubCategorias({ modalAberto, fecharModal, itemAlterar, categoriaPai }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 py-6 px-4 flex justify-center items-center z-50" >
            <section className="w-full max-w-2xl bg-white p-8 rounded-lg shadow-lg text-gray-800" >
                ...
                <header className="flex items-center gap-2 mb-6 border-b border-gray-200 pb-4" >
                    <MdCreditCard className="text-purple-600 h-8 w-8" />
                ...
                <div className="space-y-5">
                    ...
                    <input type="text" value={nome} onChange={(e) => setNome(e.target.value)} placeholder="Ex.: Super mercado, escola" className={Estilos.inputCadastro} />
                    <label className={Estilos.labelCadastro} >Tipo de </label>
