...
export default function Principal() {
    ...
    return (
        <div className='flex h-screen font-sans bg-gradient-to-bl from-[#006eff] to-[#ffaa00f4]'>
            {/* div para fechar o menu clicando fora */}
            <div className={`backdrop-blur-md fixed inset-0 bg-gray-700/50 bg-opacity-80 z-30 md:hidden ${menuAberto == true ? 'block' : 'hidden'}`} onClick={() => setMenuAberto(false)} ></div>

            {/* Sidebar */}
            <section className={`fixed top-0 left-0 h-full w-64 bg-blue-800/80 
                text-gray-200 flex flex-col z-40 rounded-lg transform transition-transform
