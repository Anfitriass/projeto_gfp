    ...
    const exibirItemLista = ({item}) => {
        return (
            <TouchableOpacity style={Estilos.itemLista}>
                ...
                <MaterialIcons name='edit' size={24} color={'#000'} onPress={() => navigation.navigate('CadContas', {Conta: item})} />
                <MaterialIcons name='delete' size={24} color={'#000'} onPress={() => botaoExcluir(item.id_conta)} />
