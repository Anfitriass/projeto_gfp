...
const Login = ({ navigation }) => {
    const [email, setEmail] = useState('coelho@gmail.com');//coelho@gmail.com // sesi@sesi.br
    const [senha, setSenha] = useState('4994'); // 4994 // 123
    ...
    return (
        <View style={Estilos_Login.container}>
            <StatusBar barStyle="light-content" backgroundColor="#d900ff" />
            <LinearGradient
                colors={['#d900ff', corPrincipal]}
            ...
            >
                ...
                <View style={Estilos_Login.header} >
                    <View style={Estilos_Login.logoContainer}>
                        <Image source={require('../assets/logoCachorro.png')} style={{ width: 100, height: 100 }} />
